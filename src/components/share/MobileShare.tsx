...
const MobileShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
   "I found this useful return on investment calculator tool, check it out: https://seosaurus.in/tools/roi-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/roi-calculator/";
